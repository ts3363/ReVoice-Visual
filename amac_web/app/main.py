...
app.mount("/recordings", StaticFiles(directory="saved_recordings"), name="recordings")
...
# Add this to app/main.py after the therapy route

@app.get("/dysarthria", response_class=HTMLResponse)
async def dysarthria_therapy():
    return templates.TemplateResponse("dysarthria.html", {"request": {}})

@app.get("/lip-therapy", response_class=HTMLResponse)
async def lip_therapy():
    return templates.TemplateResponse("lip_therapy.html", {"request": {}})
...
async def realtime_terminal():
    return templates.TemplateResponse("realtime_terminal.html", {"request": {}})
